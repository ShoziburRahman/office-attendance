-- ============================================================================
-- 0015_remove_qr_requirement.sql
-- Surgically remove QR code verification from attendance flow.
-- ============================================================================

-- 1. Update fn_check_in to remove QR validation
...
declare
  ...
  v_qr_ok            boolean := true; -- Always true now
...
-- 2. Update fn_check_out to remove QR validation
