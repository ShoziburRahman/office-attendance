-- ============================================================================
-- Final Fix for Multi-Session Logic
-- ============================================================================
...
begin
  ...
  -- 3. Multi-session authorization
  -- We count any record for today that isn't an automatic 'ABSENT' or 'LEAVE'.
  -- If a record exists with attendance_type = 'OFFICE' or 'WORK_FROM_HOME', it's a real session.
