-- ============================================================================
-- 0014_wifi_verification_fix.sql
-- Replace simple boolean wifi_verified with actual SSID/BSSID validation
-- ============================================================================
...
begin
  ...
  if p_attendance_type = 'OFFICE' then
    ...
    -- Wi-Fi Validation (Critical Fix)
    -- Check if either the SSID or BSSID matches the authorized lists in office_settings
...
-- Also update fn_check_out to match the same Wi-Fi verification logic
...
begin
  ...
  update attendance set
    ...
    working_minutes = extract(epoch from (check_out_at - check_in_at)) / 60, -- Simplified for now
