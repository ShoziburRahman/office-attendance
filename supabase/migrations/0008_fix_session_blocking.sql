-- ============================================================================
-- Updated Attendance Functions with Fixed Session Blocking
-- ============================================================================
...
begin
  ...
  -- FIX: Only block if the session is still in 'CHECKED_IN' state.
  -- If it was flagged as 'INCOMPLETE' or 'MISSING_CHECK_OUT', it no longer blocks new check-ins.
  if exists (
